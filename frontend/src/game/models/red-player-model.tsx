...
Command: npx gltfjsx@6.5.3 ./public/models/red.glb -t
*/
...
import { PlayerAnimation } from "../constants";
...
type GLTFResult = GLTF & {
  ...
  materials: {
    Astro1: THREE.MeshStandardMaterial;
...
export function RedPlayerModel({
  animation = "idle",
  position = [0, 0, 0],
  rotation = [0, 0, 0],
  scale = 1,
...
useGLTF.preload("/models/red.glb");
